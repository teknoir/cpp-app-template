#FROM  balenalib/jetson-nano-ubuntu:bionic as pahobuild
FROM  balenalib/intel-nuc-debian:buster-build as paho_build
...
##########################
FROM  balenalib/intel-nuc-debian:buster-build as app_build
