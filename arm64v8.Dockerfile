FROM balenalib/generic-aarch64-debian:buster-build as paho_build
...
##########################
FROM  balenalib/generic-aarch64-debian:buster-build as app_build
...
##########################
FROM  balenalib/generic-aarch64-debian:buster-build as app_release
