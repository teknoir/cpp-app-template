FROM balenalib/raspberrypi3-debian:buster-build as paho_build
...
##########################
FROM  balenalib/raspberrypi3-debian:buster-build as app_build
...
##########################
FROM  balenalib/raspberrypi3-debian:buster-build as app_release
